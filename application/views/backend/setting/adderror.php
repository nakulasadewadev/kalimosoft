...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">form tambah error</h6>
                <form id="send_data" class="forms-sample myForm">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label text-uppercase">kode error</label>
                                <input type="text" class="form-control" name="errorcode" id="errorcode" required/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label text-uppercase">nama error</label>
                                <input type="text" class="form-control text-capitalize" required name="errorname" id="errorname"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#send_data").submit(function(ev){
            ...
            $.ajax({
                type:"POST",
                url:"<?php echo base_url('setting/auth/'.encrypt_url('isproseserror'));?>",
